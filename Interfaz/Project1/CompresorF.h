...
#include <iostream>
	...
	/// Resumen de MyForm
	/// </summary>
	public ref class CompresorF : public System::Windows::Forms::Form
	{
	public:
		CompresorF(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->abrirbtn->Click += gcnew System::EventHandler(this, &CompresorF::abrirbtn_Click);
			// 
			// openFileDialog1
			// 
			...
			this->convbtn->Click += gcnew System::EventHandler(this, &CompresorF::convbtn_Click_1);
			// 
			// compbtn
			// 
			...
			this->compbtn->Click += gcnew System::EventHandler(this, &CompresorF::compbtn_Click);
			// 
			// enviarbtn
			// 
			...
			this->enviarbtn->Click += gcnew System::EventHandler(this, &CompresorF::Enviar_Click);
			// 
			// menuStrip1
			// 
			...
			this->ayudaToolStripMenuItem->Click += gcnew System::EventHandler(this, &CompresorF::ayudaToolStripMenuItem_Click);
			// 
			...
			this->salirToolStripMenuItem->Click += gcnew System::EventHandler(this, &CompresorF::salirToolStripMenuItem_Click);
			// 
			// label1
			// 
...
private: System::Void Enviar_Click(System::Object^  sender, System::EventArgs^  e) {
	...
	system("C:\\Users\\israd\\Dropbox\\TT\\InterfazPT\\Envio\\WindowsFormsApp1\\WindowsFormsApp1\\bin\\Debug\\Envio.exe");
}
